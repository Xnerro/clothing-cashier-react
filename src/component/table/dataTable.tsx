        ...
        <>
            ...
            >
                ...
                <ModalContent bg={useColorModeValue('gray.50', 'gray.800')}>
                    ...
                    />
                    <ModalBody>
                        {props.menu === 'Menu Pengguna' && (
                            <CreateUser close={onClose} />
                        )}
                        {props.menu === 'Data Produk' && (
                            <AddProduct close={onClose} />
                        )}
                        {props.menu === 'Menu Variant' && (
                            <AddVariant close={onClose} />
                        )}
                        {props.menu === 'Color Menu' && (
                            <AddColor close={onClose} />
                        )}
                    </ModalBody>
